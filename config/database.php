    ...
    */
    ...
    'connections' => [
        ...
        'mysql_portal_one' => [
            ...
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_PORTAL_ONE_DATABASE', 'forge'),
            'username' => env('DB_PORTAL_ONE_USERNAME', 'forge'),
            'password' => env('DB_PORTAL_ONE_PASSWORD', '3pY9n5J1emGqBFKgLtwv'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql_roche' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_ROCHE_HOST'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_ROCHE_DATABASE'),
        ...
        'mysql_yoma' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_YOMA_HOST'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_YOMA_DATABASE'),
